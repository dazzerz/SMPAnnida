...
opsBulan: [150000, 200000, 100000, 250000],
opsTahun: [75000, 40000, 84000],
...
{ name: 'Isi Kelas (Operasional)', icon: '🏫', color: '#ec4899', amount: Math.round(state.opsTahun.reduce((a, b) => a + b, 0) / 12) }
];
try {
