...
db.from('attendance_students').select('id, student_id').limit(10),
...
prevUpdate.innerText = 0;
btnImport.disabled = errorCount > 0 && processedData.length === errorCount;
...
const insertC = successCount - updateC;
importLog.innerHTML += `
